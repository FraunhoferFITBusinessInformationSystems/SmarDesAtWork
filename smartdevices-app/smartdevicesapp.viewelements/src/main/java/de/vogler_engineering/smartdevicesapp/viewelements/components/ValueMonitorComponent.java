...
public class ValueMonitorComponent extends BaseComponent<GenericValueData> {

    public ValueMonitorComponent() {
        super(ComponentType.ValueMonitor);
    }
    ...
    public View createView(Context context, LayoutInflater inflater) {
        ...
        mGridLayout = (GridLayout) inflater.inflate(R.layout.component_value_monitor,
                mContainer, false);
        ...
        mValueNominalTextView = mGridLayout.findViewById(R.id.comp_value_monitor_value_nominal);
    ...
    private void update(ValueMonitorComponentData data){
        ...
        mValueNominalTextView.setText(data.getNominalValue());
