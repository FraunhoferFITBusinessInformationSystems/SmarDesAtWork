...
public class TextViewComponentData extends ComponentData<String> {

    public TextViewComponentData(UiComponent component, ConfigurableViewModelFeatures features) {
