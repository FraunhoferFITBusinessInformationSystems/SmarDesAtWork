...
rem -------------------------------------------------------------------------------------------------
set SHORTNAME=SmarDesServices
set DISPLAYNAME="SmarDe's@Work Middleware Services"
set DESCRIPTION="Provides backend services for SmarDe's@Work solutions"
set STARTSCRIPT=StartSDServices.cmd
set STOPSCRIPT=StopSDServices.cmd

rem Dependent Services
rem The short name of dependent services separated with '#' or ';'
rem -------------------------------------------------------------------------------------------------
set DEPENDENCIES=ActiveMQArtemis
